(function() {
    ...
    */
    ...
    var ember$data$lib$core$$DS = Ember.Namespace.create({
      VERSION: '1.0.0-beta.16+canary.19584094b4'
    });
    ...
    */
    ...
    ember$data$lib$system$relationships$state$create$$Relationships.prototype.get = function(key) {
      ...
      var relationshipsByName = ember$data$lib$system$relationships$state$create$$get(this.record.constructor, 'relationshipsByName');
